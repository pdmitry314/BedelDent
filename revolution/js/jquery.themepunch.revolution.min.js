! function(jQuery, undefined) {
    ...
    jQuery.fn.extend({
        revolution: function(e) {
            ...
            return e = jQuery.extend(!0, {}, i, e), this.each(function() {
                var i = jQuery(this);
                e.minHeight = e.minHeight != undefined ? parseInt(e.minHeight, 0) : e.minHeight, e.scrolleffect.on = "on" === e.scrolleffect.fade || "on" === e.scrolleffect.blur || "on" === e.scrolleffect.grayscale, "hero" == e.sliderType && i.find(">ul>li").each(function(e) {
                    ...
                    return e.modulesfailing ? (i.html('<div style="margin:auto;line-height:40px;font-size:14px;color:#fff;padding:15px;background:#e74c3c;margin:20px 0px;">!! Error at loading Slider Revolution 5.0 Extrensions.' + e.errorm + "</div>").show(), !1) : (_R.migration != undefined && (e = _R.migration(i, e)), punchgs.force3D = !0, "on" !== e.simplifyAll && punchgs.TweenLite.lagSmoothing(1e3, 16), prepareOptions(i, e), void initSlider(i, e))
        ...
        revkill: function(e) {
            ...
            if (punchgs.TweenLite.killDelayedCallsTo(_R.showHideNavElements), i != undefined && i.length > 0 && jQuery("body").find("#" + i.attr("id")).length > 0) {
                ...
                var t = i.parent().find(".tp-bannertimer"),
                    a = i[0].opt;
                ...
                var n = "resize.revslider-" + i.attr("id");
                jQuery(window).off(n), i.find("*").each(function() {
                    var e = jQuery(this);
                    e.unbind("on, hover, mouseenter,mouseleave,mouseover, resize,restarttimer, stoptimer"), e.off("on, hover, mouseenter,mouseleave,mouseover, resize"), e.data("mySplitText", null), e.data("ctl", null), e.data("tween") != undefined && e.data("tween").kill(), e.data("kenburn") != undefined && e.data("kenburn").kill(), e.data("timeline_out") != undefined && e.data("timeline_out").kill(), e.data("timeline") != undefined && e.data("timeline").kill(), e.remove(), e.empty(), e = null
                }), punchgs.TweenLite.killTweensOf(i.find("*"), !1), punchgs.TweenLite.killTweensOf(i, !1), t.remove();
                try {
                ...
                return i.empty(), i.html(), i = null, a = null, delete this.c, delete this.opt, !0
            }
            return !1
        },
        revpause: function() {
    ...
    jQuery.extend(!0, _R, {
        ...
        compare_version: function(e) {
            return "stop" != e.check && (_R.getversion().core < e.min_core ? (e.check === undefined && (console.log("%cSlider Revolution Warning (Core:" + _R.getversion().core + ")", "color:#c0392b;font-weight:bold;"), console.log("%c     Core is older than expected (" + e.min_core + ") from " + e.alias, "color:#333"), console.log("%c     Please update Slider Revolution to the latest version.", "color:#333"), console.log("%c     It might be required to purge and clear Server/Client side Caches.", "color:#333")), e.check = "stop") : _R.getversion()[e.name] != undefined && e.version < _R.getversion()[e.name] && (e.check === undefined && (console.log("%cSlider Revolution Warning (Core:" + _R.getversion().core + ")", "color:#c0392b;font-weight:bold;"), console.log("%c     " + e.alias + " (" + e.version + ") is older than requiered (" + _R.getversion()[e.name] + ")", "color:#333"), console.log("%c     Please update Slider Revolution to the latest version.", "color:#333"), console.log("%c     It might be required to purge and clear Server/Client side Caches.", "color:#333")), e.check = "stop")), e
        },
        ...
        setSize: function(e) {
            ...
            if (n = (n = n < e.minHeight ? e.minHeight : n) < r ? r : n, "fullwidth" == e.sliderLayout && "off" == e.autoHeight && punchgs.TweenLite.set(e.c, {
                ...
                var l = (e.c.parent().width(), jQuery(window).height());
    ...
    var _ISM = _R.is_mobile(),
        ...
        initSlider = function(container, opt) {
            return container != undefined && (container.data("aimg") != undefined && ("enabled" == container.data("aie8") && _R.isIE(8) || "enabled" == container.data("amobile") && _ISM) && container.html('<img class="tp-slider-alternative-image" src="' + container.data("aimg") + '">'), container.find(">ul").addClass("tp-revslider-mainul"), opt.c = container, opt.ul = container.find(".tp-revslider-mainul"), opt.ul.find(">li").each(function(e) {
                var i = jQuery(this);
        ...
        runSlider = function(e, i) {
            ...
            if (i.shadow !== undefined && i.shadow > 0 && (e.parent().addClass("tp-shadow" + i.shadow), e.parent().append('<div class="tp-shadowcover"></div>'), e.parent().find(".tp-shadowcover").css({
                ...
                var u = jQuery.fn.jquery.split("."),
                    p = parseFloat(u[0]),
                    f = parseFloat(u[1]);
                parseFloat(u[2] || "0"), 1 == p && f < 7 && e.html('<div style="text-align:center; padding:40px 0px; font-size:20px; color:#992222;"> The Current Version of jQuery:' + u + " <br>Please update your jQuery Version to min. 1.7 in Case you wish to use the Revolution Slider Plugin</div>"), p > 1 && (i.ie = !1);
                var h = new Object;
                h.addedyt = 0, h.addedvim = 0, h.addedvid = 0, i.scrolleffect.on && (i.scrolleffect.layers = new Array), e.find(".tp-caption, .rs-background-video-layer").each(function(e) {
                    ...
                    if (t.find("iframe").each(function() {
                        ...
                        var p = t.hasClass("slidelink") ? "width:100% !important;height:100% !important;" : "",
                            ...
                            m = "";
                        "row" === g ? (t.addClass("rev_row").removeClass("tp-resizeme"), m = "rev_row_wrap") : "column" === g ? (m = "rev_column", t.addClass("rev_column_inner").removeClass("tp-resizeme"), t.data("width", "auto"), punchgs.TweenLite.set(t, {
                            width: "auto"
                        })) : "group" === g && t.removeClass("tp-resizeme");
                        var y = "",
                            w = "";
                        "row" !== g && "group" !== g && "column" !== g ? (y = "display:" + t.css("display") + ";", t.closest(".rev_column").length > 0 ? (t.addClass("rev_layer_in_column"), l = !1) : t.closest(".rev_group").length > 0 && (t.addClass("rev_layer_in_group"), l = !1)) : "column" === g && (l = !1), f.wrapper_class !== undefined && (m = m + " " + f.wrapper_class), f.wrapper_id !== undefined && (w = 'id="' + f.wrapper_id + '"'), t.wrap("<div " + w + ' class="tp-parallax-wrap ' + m + '" style="' + p + "position:" + v + ";" + y + ';visibility:hidden"><div class="tp-loop-wrap" style="' + p + "position:" + v + ";" + y + ';"><div class="tp-mask-wrap" style="' + p + "position:" + v + ";" + y + ';" ></div></div></div>'), l && i.scrolleffect.on && ("on" === i.scrolleffect.on_parallax_layers && a.isparallaxlayer || "on" === i.scrolleffect.on_layers && !a.isparallaxlayer) && i.scrolleffect.layers.push(t.parent()), d && i.scrolleffect.layers.push(t.parent()), "column" === g && (t.append('<div class="rev_column_bg rev_column_bg_man_sized" style="display:none"></div>'), t.closest(".tp-parallax-wrap").append('<div class="rev_column_bg rev_column_bg_auto_sized"></div>'));
                        var b = t.closest(".tp-loop-wrap");
                        jQuery.each(["pendulum", "rotate", "slideloop", "pulse", "wave"], function(e, i) {
                            var a = t.find(".rs-" + i),
                                n = a.data() || "";
                            "" != n && (b.data(n), b.addClass("rs-" + i), a.children(0).unwrap(), t.data("loopanimation", "on"))
                        }), t.attr("id") === undefined && t.attr("id", "layer-" + Math.round(999999999 * Math.random())), checkIDS(i, t), punchgs.TweenLite.set(t, {
                            visibility: "hidden"
                        })
                    }
                    var _ = t.data("actions");
                    _ !== undefined && _R.checkActions(t, i, _), checkHoverDependencies(t, i), _R.checkVideoApis && (h = _R.checkVideoApis(t, i, h)), _ISM && (1 != n && "true" != n || (a.autoplayonlyfirsttime = !1, n = !1), 1 != r && "true" != r && "on" != r && "1sttime" != r || (a.autoplay = "off", r = "off")), o || 1 != n && "true" != n && "1sttime" != r || "loopandnoslidestop" == s || t.closest("li.tp-revslider-slidesli").addClass("rs-pause-timer-once"), o || 1 != r && "true" != r && "on" != r && "no1sttime" != r || "loopandnoslidestop" == s || t.closest("li.tp-revslider-slidesli").addClass("rs-pause-timer-always")
                ...
                }), hideSliderUnder(e, i), contWidthManager(i), i.fallbacks.disableFocusListener || "true" == i.fallbacks.disableFocusListener || !0 === i.fallbacks.disableFocusListener || tabBlurringCheck(e, i)
            }
        },
        cArray = function(e, i) {
            if (!jQuery.isArray(e)) {
        ...
        containerResized = function(e, i) {
            if (e.trigger("revolution.slide.beforeredraw"), 1 == i.infullscreenmode && (i.minHeight = jQuery(window).height()), setCurWinRange(i), setCurWinRange(i, !0), !_R.resizeThumbsTabs || !0 === _R.resizeThumbsTabs(i)) {
                ...
                removeSlots(e, i, e, 2), "standard" === i.sliderType && (punchgs.TweenLite.set(a.find(".defaultimg"), {
                    ...
                    opt: i,
                    recall: !0
                }), "on" == a.data("kenburns") && _R.startKenBurn(a, i, a.data("kbtl").progress()), "on" == t.data("kenburns") && _R.startKenBurn(t, i, t.data("kbtl").progress()), _R.animateTheCaptions && e.find(".processing-revslide").length > 0 && _R.animateTheCaptions({
        ...
        prepareSlides = function(e, i) {
            ...
            e.parent().css({
                ...
                var o = t.data();
                t.closest(".slotholder").data(o), n.length > 0 && o.bgparallax != undefined && n.data("bgparallax", o.bgparallax), "none" != i.dottedOverlay && i.dottedOverlay != undefined && t.closest(".slotholder").append('<div class="tp-dottedoverlay ' + i.dottedOverlay + '"></div>');
                var s = t.attr("src");
                o.src = s, o.bgfit = o.bgfit || "cover", o.bgrepeat = o.bgrepeat || "no-repeat", o.bgposition = o.bgposition || "center center";
                var l = t.closest(".slotholder");
                t.parent().append('<div class="tp-bgimg defaultimg ' + r + '" style="background-color:' + t.css("backgroundColor") + ";background-repeat:" + o.bgrepeat + ";background-image:url(" + s + ");background-size:" + o.bgfit + ";background-position:" + o.bgposition + ';width:100%;height:100%;"></div>'), t.data("mediafilter", r);
                var d = document.createComment("Runtime Modification - Img tag is Still Available for SEO Goals in Source - " + t.get(0).outerHTML);
                t.replaceWith(d), (t = l.find(".tp-bgimg")).data(o), t.attr("src", s), "standard" !== i.sliderType && "undefined" !== i.sliderType || t.css({
                    opacity: 0
                })
            ...
            e.find("img,.defaultimg, .tp-svg-layer").each(function() {
                ...
                if (t.data("loaded") === undefined && r !== undefined && r.progress && r.progress.match(/loaded/g)) {
                    if (t.attr("src", r.src), "img" == r.type)
                        if (t.hasClass("defaultimg")) _R.isIE(8) ? defimg.attr("src", r.src) : t.css({
                ...
                if (1 == i.vimeoapineeded && !window.Froogaloop && (a = !0, jQuery.now() - i.vimeostarttime > 5e3 && 1 != i.vimeowarning)) {
                    i.vimeowarning = !0;
                    l = "Vimeo Froogaloop Api Could not be loaded !";
                    "https:" === location.protocol && (l += " Please Check and Renew SSL Certificate !"), console.error(l), i.c.append('<div style="position:absolute;top:50%;width:100%;color:#e74c3c;  font-size:16px; text-align:center; padding:15px;background:#000; display:block;"><strong>' + l + "</strong></div>")
                }
        ...
        swapSlide = function(e) {
            ...
            var t = e.find(".active-revslide"),
                ...
                n = a.find(".defaultimg");
            return "carousel" !== i.sliderType || i.carousel.fadein || (punchgs.TweenLite.to(i.ul, 1, {
                opacity: 1
            }), i.carousel.fadein = !0), a.index() === t.index() && !0 !== i.onlyPreparedSlide ? (a.removeClass("next-revslide"), !1) : (!0 === i.onlyPreparedSlide && (i.onlyPreparedSlide = !1, jQuery(i.li[0]).addClass("processing-revslide")), a.removeClass("next-revslide").addClass("processing-revslide"), -1 === a.index() && "carousel" === i.sliderType && (a = jQuery(i.li[0])), a.data("slide_on_focus_amount", a.data("slide_on_focus_amount") + 1 || 1), "on" == i.stopLoop && a.index() == i.lastslidetoshow - 1 && (e.find(".tp-bannertimer").css({
                visibility: "hidden"
            ...
            }, 50)), loadImages(a, i, 1), _R.preLoadAudio && _R.preLoadAudio(a, i, 1), void waitForCurrentImages(a, i, function() {
        ...
        swapSlideProgress = function(e, i) {
            ...
            if (o.sdir = c < d ? 1 : 0, "arrow" == o.sc_indicator && (0 == d && c == o.slideamount - 1 && (o.sdir = 1), d == o.slideamount - 1 && 0 == c && (o.sdir = 0)), o.lsdir = o.lsdir === undefined ? o.sdir : o.lsdir, o.dirc = o.lsdir != o.sdir, o.lsdir = o.sdir, t.index() != a.index() && 1 != o.firststart && _R.removeTheCaptions && _R.removeTheCaptions(t, o), a.hasClass("rs-pause-timer-once") || a.hasClass("rs-pause-timer-always") ? o.videoplaying = !0 : i.trigger("restarttimer"), a.removeClass("rs-pause-timer-once"), o.currentSlide = t.index(), o.nextSlide = a.index(), "carousel" == o.sliderType) l = new punchgs.TimelineLite, _R.prepareCarousel(o, l), letItFree(i, r, n, a, t, l), o.transition = 0, o.firststart = 0;
                ...
                var f = u[p];
                o.ie && ("boxfade" == f && (f = "boxslide"), "slotfade-vertical" == f && (f = "slotzoom-vertical"), "slotfade-horizontal" == f && (f = "slotzoom-horizontal")), _R.isIE(8) && (f = 11), l = _R.animateSlide(0, f, i, a, t, r, n, l), "on" == r.data("kenburns") && (_R.startKenBurn(r, o), l.add(punchgs.TweenLite.set(r, {
                    autoAlpha: 0
                }))), l.pause()
            }
            _R.scrollHandling && (_R.scrollHandling(o, !0), l.eventCallback("onUpdate", function() {
                _R.scrollHandling(o, !0)
            })), "off" != o.parallax.type && o.parallax.firstgo == undefined && _R.scrollHandling && (o.parallax.firstgo = !0, o.lastscrolltop = -999, _R.scrollHandling(o, !0), setTimeout(function() {
                o.lastscrolltop = -999, _R.scrollHandling(o, !0)
        ...
        letItFree = function(e, i, t, a, n, r) {
            ...
            var s = {};
            s.slideIndex = a.index() + 1, s.slideLIIndex = a.index(), s.slide = a, s.currentslide = a, s.prevslide = n, o.last_shown_slide = n.index(), e.trigger("revolution.slide.onchange", s), e.trigger("revolution.slide.onafterswap", s), o.duringslidechange = !1;
            var l = n.data("slide_on_focus_amount"),
                d = n.data("hideafterloop");
            0 != d && d <= l && o.c.revremoveslide(n.index());
            var c = -1 === o.nextSlide || o.nextSlide === undefined ? 0 : o.nextSlide;
            c = c > o.rowzones.length ? o.rowzones.length : c, o.rowzones != undefined && o.rowzones.length > 0 && o.rowzones[c] != undefined && c >= 0 && c <= o.rowzones.length && o.rowzones[c].length > 0 && _R.setSize(o)
        },
        ...
        restartOnFocus = function(e) {
            return e != undefined && e.c != undefined && void(1 != e.windowfocused && (e.windowfocused = !0, punchgs.TweenLite.delayedCall(.3, function() {
        ...
        tabBlurringCheck = function(e, i) {
            var t = document.documentMode === undefined,
                a = window.chrome;
            t && !a ? jQuery(window).on("focusin", function() {
                restartOnFocus(i)
