if (function(t) {
        ...
        function O(O, k) {
            var C = T || P || !k.fallbackToMouseEvents,
                ...
                E = C ? null : "mouseleave",
                L = P ? b ? "MSPointerCancel" : "pointercancel" : "touchcancel",
                D = 0,
                I = null,
                X = 0,
                N = 0,
                ...
                J = null;
            try {
                G.bind(A, tt), G.bind(L, nt)
            } catch (e) {
                t.error("events not supported " + A + "," + L + " on jQuery.swipe")
            }

            function tt(s) {
                if (!0 !== G.data(S + "_intouch") && !(t(s.target).closest(k.excludedElements, G).length > 0)) {
                    var a, o = s.originalEvent ? s.originalEvent : s,
                        l = T ? o.touches[0] : o;
                    return U = v, T ? V = o.touches.length : s.preventDefault(), D = 0, I = null, j = null, X = 0, N = 0, z = 0, F = 1, Y = 0, W = function() {
                        ...
                        var t = {};
                        return t[e] = kt(e), t[i] = kt(i), t[n] = kt(n), t[r] = kt(r), t
                    }(), wt(), !T || V === k.fingers || k.fingers === m || ft() ? (Pt(0, l), H = Rt(), 2 == V && (Pt(1, o.touches[1]), N = z = At(W[0].start, W[1].start)), (k.swipeStatus || k.pinchStatus) && (a = ot(o, U))) : a = !1, !1 === a ? (ot(o, U = w), a) : (k.hold && (J = setTimeout(t.proxy(function() {
                        G.trigger("hold", [o.target]), k.hold && (a = k.hold.call(G, o, o.target))
                    }, this), k.longTapThreshold)), bt(!0), null)
                }
            }
            ...
            function et(h) {
                ...
                if (U !== x && U !== w && !Tt()) {
                    var p, c = St(T ? u.touches[0] : u);
                    if (Q = Rt(), T && (V = u.touches.length), k.hold && clearTimeout(J), U = y, 2 == V && (0 == N ? (Pt(1, u.touches[1]), N = z = At(W[0].start, W[1].start)) : (St(u.touches[1]), z = At(W[0].end, W[1].end), W[0].end, W[1].end, j = F < 1 ? a : s), F = function(t, e) {
                            return (e / t * 1).toFixed(2)
                        }(N, z), Y = Math.abs(N - z)), V === k.fingers || k.fingers === m || !T || ft()) {
                        if (function(t, s) {
                                if (k.allowPageScroll === o || ft()) t.preventDefault();
                                else {
                            ...
                            }(c.start, c.end)), D = function(t, e) {
                                return Math.round(Math.sqrt(Math.pow(e.x - t.x, 2) + Math.pow(e.y - t.y, 2)))
                            }(c.start, c.end), X = Ct(), function(t, e) {
                                e = Math.max(e, Ot(t)), B[t].distance = e
                            }(I, D), (k.swipeStatus || k.pinchStatus) && (p = ot(u, U)), !k.triggerOnTouchEnd || k.triggerOnTouchLeave) {
                            var f = !0;
                            ...
                            }!k.triggerOnTouchEnd && f ? U = at(y) : k.triggerOnTouchLeave && !f && (U = at(x)), U != w && U != x || ot(u, U)
                        }
                    } else ot(u, U = w);
                    !1 === p && ot(u, U = w)
                }
            ...
            function it(t) {
                ...
                return T && e.touches.length > 0 ? (q = Rt(), Z = event.touches.length + 1, !0) : (Tt() && (V = Z), Q = Rt(), X = Ct(), ut() || !ht() ? ot(e, U = w) : k.triggerOnTouchEnd || 0 == k.triggerOnTouchEnd && U === y ? (t.preventDefault(), ot(e, U = x)) : !k.triggerOnTouchEnd && vt() ? lt(e, U = x, p) : U === y && ot(e, U = w), bt(!1), null)
            }

            function nt() {
                V = 0, Q = 0, H = 0, N = 0, z = 0, F = 1, wt(), bt(!1)
            }

            function rt(t) {
                var e = t.originalEvent;
                k.triggerOnTouchLeave && ot(e, U = at(x))
            }

            function st() {
                G.unbind(A, tt), G.unbind(L, nt), G.unbind(R, et), G.unbind(M, it), E && G.unbind(E, rt), bt(!1)
            }
            ...
            function at(t) {
                var e = t,
                    ...
                    n = ht(),
                    r = ut();
                return !i || r ? e = w : !n || t != y || k.triggerOnTouchEnd && !k.triggerOnTouchLeave ? !n && t == x && k.triggerOnTouchLeave && (e = w) : e = x, e
            }

            function ot(t, e) {
                var i = void 0;
                return dt() && _t() || _t() ? i = lt(t, e, h) : (ct() && ft() || ft()) && !1 !== i && (i = lt(t, e, u)), xt() && yt() && !1 !== i ? i = lt(t, e, c) : X > k.longTapThreshold && D < g && k.longTap && !1 !== i ? i = lt(t, e, f) : 1 !== V && T || !(isNaN(D) || D < k.threshold) || !vt() || !1 === i || (i = lt(t, e, p)), e === w && nt(), e === x && (T ? 0 == t.touches.length && nt() : nt()), i
            }

            function lt(o, l, d) {
                var _ = void 0;
                if (d == h) {
                    if (G.trigger("swipeStatus", [l, I || null, D || 0, X || 0, V, W]), k.swipeStatus && !1 === (_ = k.swipeStatus.call(G, o, l, I || null, D || 0, X || 0, V, W))) return !1;
                    if (l == x && dt()) {
                        if (G.trigger("swipe", [I, D, X, V, W]), k.swipe && !1 === (_ = k.swipe.call(G, o, I, D, X, V, W))) return !1;
                        switch (I) {
                            case e:
                                G.trigger("swipeLeft", [I, D, X, V, W]), k.swipeLeft && (_ = k.swipeLeft.call(G, o, I, D, X, V, W));
                                break;
                            case i:
                                G.trigger("swipeRight", [I, D, X, V, W]), k.swipeRight && (_ = k.swipeRight.call(G, o, I, D, X, V, W));
                                break;
                            case n:
                                G.trigger("swipeUp", [I, D, X, V, W]), k.swipeUp && (_ = k.swipeUp.call(G, o, I, D, X, V, W));
                                break;
                            case r:
                                G.trigger("swipeDown", [I, D, X, V, W]), k.swipeDown && (_ = k.swipeDown.call(G, o, I, D, X, V, W))
                        }
                    }
                }
                if (d == u) {
                    if (G.trigger("pinchStatus", [l, j || null, Y || 0, X || 0, V, F, W]), k.pinchStatus && !1 === (_ = k.pinchStatus.call(G, o, l, j || null, Y || 0, X || 0, V, F, W))) return !1;
                    if (l == x && ct()) switch (j) {
                        case s:
                            G.trigger("pinchIn", [j || null, Y || 0, X || 0, V, F, W]), k.pinchIn && (_ = k.pinchIn.call(G, o, j || null, Y || 0, X || 0, V, F, W));
                            break;
                        case a:
                            G.trigger("pinchOut", [j || null, Y || 0, X || 0, V, F, W]), k.pinchOut && (_ = k.pinchOut.call(G, o, j || null, Y || 0, X || 0, V, F, W))
                    }
                }
                return d == p ? l !== w && l !== x || (clearTimeout(K), clearTimeout(J), yt() && !xt() ? ($ = Rt(), K = setTimeout(t.proxy(function() {
                    $ = null, G.trigger("tap", [o.target]), k.tap && (_ = k.tap.call(G, o, o.target))
                }, this), k.doubleTapThreshold)) : ($ = null, G.trigger("tap", [o.target]), k.tap && (_ = k.tap.call(G, o, o.target)))) : d == c ? l !== w && l !== x || (clearTimeout(K), $ = null, G.trigger("doubletap", [o.target]), k.doubleTap && (_ = k.doubleTap.call(G, o, o.target))) : d == f && (l !== w && l !== x || (clearTimeout(K), $ = null, G.trigger("longtap", [o.target]), k.longTap && (_ = k.longTap.call(G, o, o.target)))), _
            }

            function ht() {
                var t = !0;
                return null !== k.threshold && (t = D >= k.threshold), t
            }

            function ut() {
                var t = !1;
                return null !== k.cancelThreshold && null !== I && (t = Ot(I) - D >= k.cancelThreshold), t
            }

            function pt() {
                return !k.maxTimeThreshold || !(X >= k.maxTimeThreshold)
            }

            function ct() {
                var t = mt(),
                    e = gt(),
                    i = null === k.pinchThreshold || Y >= k.pinchThreshold;
                return t && e && i
            }
            ...
            function mt() {
                return V === k.fingers || k.fingers === m || !T
            }
            ...
            function xt() {
                if (null == $) return !1;
                var t = Rt();
                return yt() && t - $ <= k.doubleTapThreshold
            }
            ...
            function Tt() {
                var t = !1;
                q && (Rt() - q <= k.fingerReleaseThreshold && (t = !0));
                return t
            }

            function bt(t) {
                !0 === t ? (G.bind(R, et), G.bind(M, it), E && G.bind(E, rt)) : (G.unbind(R, et, !1), G.unbind(M, it, !1), E && G.unbind(E, rt, !1)), G.data(S + "_intouch", !0 === t)
            }

            function Pt(t, e) {
                var i = void 0 !== e.identifier ? e.identifier : 0;
                return W[t].identifier = i, W[t].start.x = W[t].end.x = e.pageX || e.clientX, W[t].start.y = W[t].end.y = e.pageY || e.clientY, W[t]
            }

            function St(t) {
                var e = function(t) {
                    for (var e = 0; e < W.length; e++)
                        if (W[e].identifier == t) return W[e]
                }(void 0 !== t.identifier ? t.identifier : 0);
                return e.end.x = t.pageX || t.clientX, e.end.y = t.pageY || t.clientY, e
            }

            function Ot(t) {
                if (B[t]) return B[t].distance
            }
            ...
            this.enable = function() {
                return G.bind(A, tt), G.bind(L, nt), G
            }, this.disable = function() {
                return st(), G
            }, this.destroy = function() {
                return st(), G.data(S, null), G
        ...
        t.fn.swipe = function(e) {
            ...
            if (n && "string" == typeof e) {
                ...
                e || (e = {});
                return e = t.extend({}, t.fn.swipe.defaults, e), this.each(function() {
                    var i = t(this),
                        n = i.data(S);
...
if (1 == window.tplogs) try {
        ...
        if (!i.TweenLite) {
            var n, r, s, a, o, l = function(t) {
                ...
                _ = function(e, n, r, s) {
                    ...
                    this.check = function(o) {
                        for (var h, u, p, c, f = n.length, m = f; --f > -1;)(h = d[n[f]] || new _(n[f], [])).gsClass ? (a[f] = h.gsClass, m--) : o && h.sc.push(this);
                        if (0 === m && r)
                            for (p = (u = ("com.greensock." + e).split(".")).pop(), c = l(u.join("."))[p] = this.gsClass = r.apply(r, a), s && (i[p] = c, "function" == typeof define && define.amd ? define((t.GreenSockAMDPath ? t.GreenSockAMDPath + "/" : "") + e.split(".").pop(), [], function() {
                                    return c
                                }) : "TweenLite" === e && "undefined" != typeof module && module.exports && (module.exports = c)), f = 0; this.sc.length > f; f++) this.sc[f].check()
                    }, this.check(!0)
                },
            ...
            (s = b.prototype).addEventListener = function(t, e, i, n, r) {
                ...
                var s, l, h = this._listeners[t],
                    u = 0;
                for (null == h && (this._listeners[t] = h = []), l = h.length; --l > -1;)(s = h[l]).c === e && s.s === i ? h.splice(l, 1) : 0 === u && r > s.pr && (u = l + 1);
                h.splice(u, 0, {
                    c: e,
                    s: i,
                    up: n,
            ...
            var P = t.requestAnimationFrame,
                ...
                k = O();
            for (r = (n = ["ms", "moz", "webkit", "o"]).length; --r > -1 && !P;) P = t[n[r] + "RequestAnimationFrame"], S = t[n[r] + "CancelAnimationFrame"] || t[n[r] + "CancelRequestAnimationFrame"];
            g("Ticker", function(t, e) {
                var i, n, r, s, l, h = this,
                    ...
                    m = function(t) {
                        var e, a, o = O() - k;
                        o > d && (p += o - _), k += o, h.time = (k - p) / 1e3, e = h.time - l, (!i || e > 0 || !0 === t) && (h.frame++, l += e + (e >= s ? .004 : s - e), a = !0), !0 !== t && (r = n(m)), a && h.dispatchEvent("tick")
                    };
                b.call(h), h.time = h.frame = 0, h.tick = function() {
                    ...
                    return arguments.length ? (s = 1 / ((i = t) || 60), l = this.time + s, void h.wake()) : i
                }, h.useRAF = function(t) {
            ...
            A(), s.play = function(t, e) {
                ...
                if (this._timeline) {
                    ...
                    this._gc && this._enabled(!0, !1), (this._totalTime !== t || 0 === this._duration) && (this.render(t, e, !1), L.length && G())
                }
                return this
            ...
            var M = g("TweenLite", function(e, i, n) {
                    ...
                    if (this._overwrite = l = null == l ? Y[M.defaultOverwrite] : "number" == typeof l ? l >> 0 : Y[l], (o || e instanceof Array || e.push && f(e)) && "number" != typeof e[0])
                    ...
                    else this._propLookup = {}, this._siblings = U(e, this, !1), 1 === l && this._siblings.length > 1 && W(e, this, null, 1, this._siblings);
            ...
            (s = M.prototype = new C).constructor = M, s.kill()._gc = !1, s.ratio = 0, s._firstPT = s._targets = s._overwrittenProps = s._startAt = null, s._notifyPluginsOfEnabled = s._lazy = !1, M.version = "1.14.2", M.defaultEase = s._ease = new x(null, null, 1, 1), M.defaultOverwrite = "auto", M.ticker = a, M.autoSleep = !0, M.lagSmoothing = function(t, e) {
                a.lagSmoothing(t, e)
            ...
            var L = [],
                ...
                j = C._rootFramesTimeline = new R,
                B = C._rootTimeline = new R,
                G = I.lazyRender = function() {
                    var t, e = L.length;
                    for (D = {}; --e > -1;)(t = L[e]) && !1 !== t._lazy && (t.render(t._lazy[0], t._lazy[1], !0), t._lazy = !1);
                    L.length = 0
                };
            B._startTime = a.time, j._startTime = a.frame, B._active = j._active = !0, setTimeout(G, 1), C._updateRoot = M.render = function() {
                var t, e, i;
                if (L.length && G(), B.render((a.time - B._startTime) * B._timeScale, !1, !1), j.render((a.frame - j._startTime) * j._timeScale, !1, !1), L.length && G(), !(a.frame % 120)) {
                    for (i in N) {
                        for (t = (e = N[i].tweens).length; --t > -1;) e[t]._gc && e.splice(t, 1);
                        0 === e.length && delete N[i]
                    }
                    if ((!(i = B._first) || i._paused) && M.autoSleep && !j._first && 1 === a._listeners.tick.length) {
            ...
            var U = function(t, e, i) {
                    ...
                    if (N[s || (t._gsTweenID = s = "t" + z++)] || (N[s] = {
                            target: t,
                            tweens: []
                        }), e && ((n = N[s].tweens)[r = n.length] = e, i))
                        for (; --r > -1;) n[r] === e && n.splice(r, 1);
                    return N[s].tweens
                },
                V = function(t, e, i, n) {
                    var r, s, a = t.vars.onOverwrite;
                    return a && (r = a(t, e, i, n)), (a = M.onOverwrite) && (s = a(t, e, i, n)), !1 !== r && !1 !== s
                },
                W = function(t, e, i, n, r) {
                    var s, a, o, l;
                    if (1 === n || n >= 4) {
                        for (l = r.length, s = 0; l > s; s++)
                            if ((o = r[s]) !== e) o._gc || V(o, e) && o._enabled(!1, !1) && (a = !0);
                            else if (5 === n) break;
                        return a
                    }
                    var h, p = e._startTime + u,
                        ...
                        f = 0,
                        d = 0 === e._duration;
                    for (s = r.length; --s > -1;)(o = r[s]) === e || o._gc || o._paused || (o._timeline !== e._timeline ? (h = h || H(e, 0, d), 0 === H(o, h, d) && (c[f++] = o)) : p >= o._startTime && o._startTime + o.totalDuration() / o._timeScale > p && ((d || !o._initted) && 2e-10 >= p - o._startTime || (c[f++] = o)));
                    for (s = f; --s > -1;)
                        if (o = c[s], 2 === n && o._kill(i, t, e) && (a = !0), 2 !== n || !o._firstPT && o._initted) {
                            if (2 !== n && !V(o, e)) continue;
                            o._enabled(!1, !1) && (a = !0)
                        }
                    return a
                },
                H = function(t, e, i) {
                    ...
                    return (s /= r) > e ? s - e : i && s === e || !t._initted && 2 * u > s - e ? u : (s += t.totalDuration() / t._timeScale / r) > e + u ? 0 : s - e - u
                };
            s._init = function() {
                ...
                if (s.startAt) {
                    ...
                    if (r.overwrite = !1, r.immediateRender = !0, r.lazy = l && !1 !== s.lazy, r.startAt = r.delay = null, this._startAt = M.to(this.target, 0, r), l)
                        if (this._time > 0) this._startAt = null;
                        else if (0 !== o) return
                } else if (s.runBackwards && 0 !== o)
                    if (this._startAt) this._startAt.render(-1, !0), this._startAt.kill(), this._startAt = null;
                    else {
                        for (n in 0 !== this._time && (l = !1), i = {}, s) F[n] && "autoCSS" !== n || (i[n] = s[n]);
                ...
                var s, a, o, l, h, u;
                if (null == e) return !1;
                for (s in D[e._gsTweenID] && G(), this.vars.css || e.style && e !== t && e.nodeType && X.css && !1 !== this.vars.autoCSS && function(t, e) {
                        var i, n = {};
                        for (i in t) F[i] || i in e && "transform" !== i && "x" !== i && "y" !== i && "width" !== i && "height" !== i && "className" !== i && "border" !== i || !(!X[i] || X[i] && X[i]._autoCSS) || (n[i] = t[i], delete t[i]);
                        t.css = n
                    }(this.vars, e), this.vars) {
                    if (u = this.vars[s], F[s]) u && (u instanceof Array || u.push && f(u)) && -1 !== u.join("").indexOf("{self}") && (this.vars[s] = u = this._swapSelfInParams(u, this));
                    else if (X[s] && (l = new X[s])._onInitTween(e, this.vars[s], this)) {
                        for (this._firstPT = h = {
                                _next: this._firstPT,
                                t: l,
                                p: "setRatio",
                ...
                return r && this._kill(r, e) ? this._initProps(e, i, n, r) : this._overwrite > 1 && this._firstPT && n.length > 1 && W(e, this, i, this._overwrite, n) ? (this._kill(i, e), this._initProps(e, i, n, r)) : (this._firstPT && (!1 !== this.vars.lazy && this._duration || this.vars.lazy && !this._duration) && (D[e._gsTweenID] = !0), o)
            }, s.render = function(t, e, i) {
                ...
                if (this._time !== o || i) {
                    ...
                    for (!1 !== this._lazy && (this._lazy = !1), this._active || !this._paused && this._time !== o && t >= 0 && (this._active = !0), 0 === o && (this._startAt && (t >= 0 ? this._startAt.render(t, e, i) : r || (r = "_dummyGS")), this.vars.onStart && (0 !== this._time || 0 === l) && (e || this.vars.onStart.apply(this.vars.onStartScope || this, this.vars.onStartParams || y))), s = this._firstPT; s;) s.f ? s.t[s.p](s.c * this.ratio + s.s) : s.t[s.p] = s.c * this.ratio + s.s, s = s._next;
                    this._onUpdate && (0 > t && this._startAt && -1e-4 !== t && this._startAt.render(t, e, i), e || (this._time !== o || n) && this._onUpdate.apply(this.vars.onUpdateScope || this, this.vars.onUpdateParams || y)), r && (!this._gc || i) && (0 > t && this._startAt && !this._onUpdate && -1e-4 !== t && this._startAt.render(t, e, i), n && (this._timeline.autoRemoveChildren && this._enabled(!1, !1), this._active = !1), !e && this.vars[r] && this.vars[r].apply(this.vars[r + "Scope"] || this, this.vars[r + "Params"] || y), 0 === l && this._rawPrevTime === u && a !== u && (this._rawPrevTime = 0))
                }
            }, s._kill = function(t, e, i) {
                if ("all" === t && (t = null), null == t && (null == e || e === this.target)) return this._lazy = !1, this._enabled(!1, !1);
                var n, r, s, a, o, l, h, u, p;
                if (e = "string" != typeof e ? e || this._targets || this.target : M.selector(e) || e, (f(e) || E(e)) && "number" != typeof e[0])
                ...
                if (null == t) return [];
                var i, n, r, s;
                if (t = "string" != typeof t ? t : M.selector(t) || t, (f(t) || E(t)) && "number" != typeof t[0]) {
            ...
            if (s = Q.prototype, Q.version = "1.10.1", Q.API = 2, s._firstPT = null, s._addTween = function(t, e, i, n, r, s) {
                    ...
                    for (var e = t.length; --e > -1;) t[e].API === Q.API && (X[(new t[e])._propName] = t[e]);
                    return !0
                }, m.plugin = function(t) {
        ...
        _gsScope._gsDefine("TimelineLite", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(t, e, i) {
            ...
            return n.version = "1.14.2", _.constructor = n, _.kill()._gc = _._forcingPlayhead = !1, _.to = function(t, e, n, r) {
                ...
                for ("string" == typeof t && (t = i.selector(t) || t), a(t = t || []) && (t = d(t)), 0 > (s = s || 0) && ((t = d(t)).reverse(), s *= -1), p = 0; t.length > p; p++) r.startAt && (r.startAt = c(r.startAt)), f.to(t[p], e, c(r), p * s);
                return this.add(f, o)
                ...
                if (e.prototype.add.call(this, r, s), (this._gc || this._time === this._duration) && !this._paused && this._duration < this.duration())
                    for (d = (f = this).rawTime() > r._startTime; f._timeline;) d && f._timeline.smoothChildTiming ? f.totalTime(f._totalTime, !0) : f._gc && f._enabled(!0, !1), f = f._timeline;
                return this
            }, _.remove = function(e) {
    ...
    function(t) {
        ...
        _gsScope._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function(t, e) {
            ...
            var h, u, p, c, f, d, _ = /(?:\d|\-\d|\.\d|\-\.\d)+/g,
                ...
                Q = z.convertToPixels = function(t, i, n, r, s) {
                    ...
                    if (f && (n = -n), "%" === r && -1 !== i.indexOf("border")) o = n / 100 * (u ? t.clientWidth : t.clientHeight);
                        ...
                        if (c.cssText = "border:0 solid red;position:" + H(t, "position") + ";line-height:0;", "%" !== r && p.appendChild) c[u ? "borderLeftWidth" : "borderTopWidth"] = n + r;
                            ...
                            if (l = (p = t.parentNode || I.body)._gsCache, h = e.ticker.frame, l && u && l.time === h) return l.width * n / 100;
                            c[u ? "width" : "height"] = n + r
                        }
                        p.appendChild(X), o = parseFloat(X[u ? "offsetWidth" : "offsetHeight"]), p.removeChild(X), u && "%" === r && !1 !== a.cacheWidths && ((l = p._gsCache = p._gsCache || {}).time = h, l.width = o / n * 100), 0 !== o || s || (o = Q(t, i, n, r, !0))
                    }
                    return f ? -o : o
                },
                ...
                rt = function(t, e, i, n) {
                    var r, s, a, o;
                    return null == t ? o = e : "number" == typeof t ? o = t : (r = 360, s = t.split("_"), a = Number(s[0].replace(v, "")) * (-1 === t.indexOf("rad") ? 1 : L) - ("=" === t.charAt(1) ? 0 : e), s.length && (n && (n[i] = e + a), -1 !== t.indexOf("short") && ((a %= r) !== a % 180 && (a = 0 > a ? a + r : a - r)), -1 !== t.indexOf("_cw") && 0 > a ? a = (a + 9999999999 * r) % r - (0 | a / r) * r : -1 !== t.indexOf("ccw") && a > 0 && (a = (a - 9999999999 * r) % r - (0 | a / r) * r)), o = e + a), 1e-6 > o && o > -1e-6 && (o = 0), o
                },
                st = {
                    aqua: [0, 255, 255],
                    lime: [0, 255, 0],
                ...
                ot = a.parseColor = function(t) {
                    var e, i, n, r, s, a;
                    return t && "" !== t ? "number" == typeof t ? [t >> 16, 255 & t >> 8, 255 & t] : ("," === t.charAt(t.length - 1) && (t = t.substr(0, t.length - 1)), st[t] ? st[t] : "#" === t.charAt(0) ? (4 === t.length && (e = t.charAt(1), i = t.charAt(2), n = t.charAt(3), t = "#" + e + e + i + i + n + n), [(t = parseInt(t.substr(1), 16)) >> 16, 255 & t >> 8, 255 & t]) : "hsl" === t.substr(0, 3) ? (t = t.match(_), r = Number(t[0]) % 360 / 360, s = Number(t[1]) / 100, e = 2 * (a = Number(t[2]) / 100) - (i = .5 >= a ? a * (s + 1) : a + s - a * s), t.length > 3 && (t[3] = Number(t[3])), t[0] = at(r + 1 / 3, e, i), t[1] = at(r, e, i), t[2] = at(r - 1 / 3, e, i), t) : ((t = t.match(_) || st.transparent)[0] = Number(t[0]), t[1] = Number(t[1]), t[2] = Number(t[2]), t.length > 3 && (t[3] = Number(t[3])), t)) : st.black
                },
            ...
            var ht = function(t, e, i, n) {
                    ...
                    return u ? r = e ? function(t) {
                        ...
                        if (e = (t.match(lt) || [s])[0], f = (c = t.split(e).join("").match(g) || []).length, u > f--)
                ...
                ct = (z._parseToProxy = function(t, e, i, n, r, s) {
                    ...
                    for (i._transform = null, D = e, n = u = i.parse(t, e, n, r), D = _, s && (i._transform = d, p && (p._prev = null, p._prev && (p._prev._next = null))); n && n !== p;) {
                        if (1 >= n.type && (f[o = n.p] = n.s + n.c, c[o] = n.s, s || (h = new pt(n, "s", o, h, n.r), n.c = 0), 1 === n.type))
                            for (a = n.l; --a > 0;) l = "xn" + a, f[o = n.p + "_" + l] = n.data[l], c[o] = n[l], s || (h = new pt(n, l, o, h, n.rxp[l]));
                        n = n._next
                    }
                    return {
                        proxy: c,
                ...
                ft = a.parseComplex = function(t, e, i, n, r, s, a, o, l, u) {
                    a = new ct(t, e, 0, 0, a, u ? 2 : 1, null, !1, o, i = i || s || "", n), n += "";
                    var p, c, f, d, g, v, y, x, w, T, P, S, O = i.split(", ").join(",").split(" "),
                        k = n.split(", ").join(",").split(" "),
                        C = O.length,
                        A = !1 !== h;
                    for ((-1 !== n.indexOf(",") || -1 !== i.indexOf(",")) && (O = O.join(" ").replace(M, ", ").split(" "), k = k.join(" ").replace(M, ", ").split(" "), C = O.length), C !== k.length && (C = (O = (s || "").split(" ")).length), a.plugin = l, a.setRatio = u, p = 0; C > p; p++)
                        if (d = O[p], g = k[p], (x = parseFloat(d)) || 0 === x) a.appendXtra("", x, it(g, x), g.replace(m, ""), A && -1 !== g.indexOf("px"), !0);
                        else if (r && ("#" === d.charAt(0) || st[d] || b.test(d))) S = "," === g.charAt(g.length - 1) ? ")," : ")", d = ot(d), g = ot(g), (w = d.length + g.length > 6) && !Y && 0 === g[3] ? (a["xs" + a.l] += a.l ? " transparent" : "transparent", a.e = a.e.split(k[p]).join("transparent")) : (Y || (w = !1), a.appendXtra(w ? "rgba(" : "rgb(", d[0], g[0] - d[0], ",", !0, !0).appendXtra("", d[1], g[1] - d[1], ",", !0).appendXtra("", d[2], g[2] - d[2], w ? "," : S, !0), w && (d = 4 > d.length ? 1 : d[3], a.appendXtra("", d, (4 > g.length ? 1 : g[3]) - d, S, !1)));
                    else if (v = d.match(_)) {
                ...
                dt = 9;
            for ((l = ct.prototype).l = l.pr = 0; --dt > 0;) l["xn" + dt] = 0, l["xs" + dt] = "";
            ...
            var _t = function(t, e) {
                    e = e || {}, this.p = e.prefix && V(t) || t, o[t] = o[this.p] = this, this.format = e.formatter || ht(e.defaultValue, e.color, e.collapsible, e.multi), e.parser && (this.parse = e.parser), this.clrs = e.color, this.multi = e.multi, this.keyword = e.keyword, this.dflt = e.defaultValue, this.pr = e.priority || 0
                },
                mt = z._registerComplexSpecialProp = function(t, e, i) {
                    ...
                    var n, r = t.split(","),
                        s = e.defaultValue;
                    for (i = i || [s], n = 0; r.length > n; n++) e.prefix = 0 === n && e.prefix, e.defaultValue = i[n] || s, new _t(r[n], e)
                },
                gt = function(t) {
                    if (!o[t]) {
            ...
            (l = _t.prototype).parseComplex = function(t, e, i, n, r, s) {
                var a, o, l, h, u, p = this.keyword;
                if (this.multi && (M.test(i) || M.test(e) ? (o = e.replace(M, "|").split("|"), l = i.replace(M, "|").split("|")) : p && (o = [e], l = [i])), l) {
                    for (h = l.length > o.length ? l.length : o.length, a = 0; h > a; a++) e = o[a] = o[a] || this.dflt, i = l[a] = l[a] || this.dflt, p && (e.indexOf(p) !== (u = i.indexOf(p)) && ((i = -1 === u ? l : o)[a] += " " + p));
                    e = o.join(", "), i = l.join(", ")
                }
            ...
            var vt, yt = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),
                ...
                Ct = function() {
                    ...
                    return I.createElementNS && !n && (t = Ot("svg", kt), i = (e = Ot("rect", t, {
                        width: 100,
                        height: 50,
                        x: 100
                    })).getBoundingClientRect().left, e.style[Tt] = "50% 50%", e.style[xt] = "scale(0.5,0.5)", n = i === e.getBoundingClientRect().left, kt.removeChild(t)), n
                }(),
                At = function(t, e, i) {
                    var n = t.getBBox();
                ...
                Rt = z.getTransform = function(t, e, i, n) {
                    ...
                    var s, o, l, h, u, p, c, f, d, _, m, g, v, y = i && t._gsTransform || new Pt,
                        x = 0 > y.scaleX,
                        w = 2e-5,
                        T = 1e5,
                        b = 179.99,
                        P = b * E,
                        S = bt && (parseFloat(H(t, Tt, e, !1, "0 0 0").split(" ")[2]) || y.zOrigin) || 0,
                        O = parseFloat(a.defaultTransformPerspective) || 0;
                    if (xt ? s = H(t, wt, e, !0) : t.currentStyle && (s = (s = t.currentStyle.filter.match(A)) && 4 === s.length ? [s[0].substr(4), Number(s[2].substr(4)), Number(s[1].substr(4)), s[3].substr(4), y.x || 0, y.y || 0].join(",") : ""), s && "none" !== s && "matrix(1, 0, 0, 1, 0, 0)" !== s) {
                        for (l = (o = (s || "").match(/(?:\-|\b)[\d\-\.e]+\b/gi) || []).length; --l > -1;) h = Number(o[l]), o[l] = (u = h - (h |= 0)) ? (0 | u * T + (0 > u ? -.5 : .5)) / T + h : h;
                        if (16 === o.length) {
                            var k = o[8],
                                C = o[9],
                                R = o[10],
                                ...
                                D = o[13],
                                I = o[14];
                            if (y.zOrigin && (M = k * (I = -y.zOrigin) - o[12], D = C * I - o[13], I = R * I + y.zOrigin - o[14]), !i || n || null == y.rotationX) {
                        ...
                        for (l in y.zOrigin = S, y) w > y[l] && y[l] > -w && (y[l] = 0)
                    } else y = {
                        x: 0,
                        y: 0,
                        z: 0,
                ...
                Mt = function(t) {
                    ...
                    if (c) {
                        ...
                        if (null != n.ox && (T += (f = (n.oxp ? .01 * m * n.ox : n.ox) - m / 2) - (f * o + (_ = (n.oyp ? .01 * g * n.oy : n.oy) - g / 2) * l), b += _ - (f * h + _ * u)), v ? w += ", Dx=" + ((f = m / 2) - (f * o + (_ = g / 2) * l) + T) + ", Dy=" + (_ - (f * h + _ * u) + b) + ")" : w += ", sizingMethod='auto expand')", p.filter = -1 !== e.indexOf("DXImageTransform.Microsoft.Matrix(") ? e.replace(R, w) : w + " " + e, (0 === t || 1 === t) && 1 === o && 0 === l && 0 === h && 1 === u && (v && -1 === w.indexOf("Dx=0, Dy=0") || x.test(e) && 100 !== parseFloat(RegExp.$1) || -1 === e.indexOf(e.indexOf("Alpha")) && p.removeAttribute("filter")), !v) {
                            var P, S, O, k = 8 > d ? 1 : -1;
                            for (f = n.ieOffsetX || 0, _ = n.ieOffsetY || 0, n.ieOffsetX = Math.round((m - ((0 > o ? -o : o) * m + (0 > l ? -l : l) * g)) / 2 + T), n.ieOffsetY = Math.round((g - ((0 > u ? -u : u) * g + (0 > h ? -h : h) * m)) / 2 + b), dt = 0; 4 > dt; dt++) O = (i = -1 !== (P = c[S = J[dt]]).indexOf("px") ? parseFloat(P) : Q(this.t, S, parseFloat(P), P.replace(y, "")) || 0) !== n[S] ? 2 > dt ? -n.ieOffsetX : -n.ieOffsetY : 2 > dt ? f - n.ieOffsetX : _ - n.ieOffsetY, p[S] = (n[S] = Math.round(i - O * (0 === dt || 2 === dt ? 1 : k))) + "px"
                        }
                    }
                },
                Et = z.set3DTransformRatio = function(t) {
                    var e, i, n, r, s, a, o, l, h, u, p, f, d, _, m, g, v, y, x, w, T, b, P, S = this.data,
                        ...
                        D = S.z,
                        I = S.perspective;
                    if (1 !== t && 0 !== t || "auto" !== S.force3D || S.rotationY || S.rotationX || 1 !== R || I || D) {
                        if (c) {
                            var X = 1e-4;
                            X > C && C > -X && (C = R = 2e-5), X > A && A > -X && (A = R = 2e-5), !I || S.z || S.rotationX || S.rotationY || (I = 0)
                        }
                        if (k || S.skewX) e = y = Math.cos(k), s = x = Math.sin(k), S.skewX && (k -= S.skewX * E, y = Math.cos(k), x = Math.sin(k), "simple" === S.skewType && (w = Math.tan(S.skewX * E), y *= w = Math.sqrt(1 + w * w), x *= w)), i = -x, a = y;
                        else {
            ...
            mt("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent", {
                parser: function(t, e, i, n, s, o, l) {
                    ...
                    var h, u, p, c, f, d, _, m = n._transform = Rt(t, r, !0, l.parseTransform),
                        ...
                        y = l,
                        x = {};
                    if ("string" == typeof y.transform && xt)(p = X.style)[xt] = y.transform, p.display = "block", p.position = "absolute", I.body.appendChild(X), h = Rt(X, null, !1), I.body.removeChild(X);
                    else if ("object" == typeof y) {
                        if (h = {
                                scaleX: nt(null != y.scaleX ? y.scaleX : y.scale, m.scaleX),
                                scaleY: nt(null != y.scaleY ? y.scaleY : y.scale, m.scaleY),
                                scaleZ: nt(y.scaleZ, m.scaleZ),
                                x: nt(y.x, m.x),
                                y: nt(y.y, m.y),
                                z: nt(y.z, m.z),
                                xPercent: nt(y.xPercent, m.xPercent),
                                yPercent: nt(y.yPercent, m.yPercent),
                                perspective: nt(y.transformPerspective, m.perspective)
                            }, null != (_ = y.directionalRotation))
                            if ("object" == typeof _)
                                for (p in _) y[p] = _[p];
                            else y.rotation = _;
                        "string" == typeof y.x && -1 !== y.x.indexOf("%") && (h.x = 0, h.xPercent = nt(y.x, m.xPercent)), "string" == typeof y.y && -1 !== y.y.indexOf("%") && (h.y = 0, h.yPercent = nt(y.y, m.yPercent)), h.rotation = rt("rotation" in y ? y.rotation : "shortRotation" in y ? y.shortRotation + "_short" : "rotationZ" in y ? y.rotationZ : m.rotation, m.rotation, "rotation", x), bt && (h.rotationX = rt("rotationX" in y ? y.rotationX : "shortRotationX" in y ? y.shortRotationX + "_short" : m.rotationX || 0, m.rotationX, "rotationX", x), h.rotationY = rt("rotationY" in y ? y.rotationY : "shortRotationY" in y ? y.shortRotationY + "_short" : m.rotationY || 0, m.rotationY, "rotationY", x)), h.skewX = null == y.skewX ? m.skewX : rt(y.skewX, m.skewX), h.skewY = null == y.skewY ? m.skewY : rt(y.skewY, m.skewY), (u = h.skewY - m.skewY) && (h.skewX += u, h.rotation += u)
                    }
                    for (bt && null != y.force3D && (m.force3D = y.force3D, d = !0), m.skewType = y.skewType || m.skewType || a.defaultSkewType, (f = m.force3D || m.z || m.rotationX || m.rotationY || h.z || h.rotationX || h.rotationY || h.perspective) || null == y.scale || (h.scaleZ = 1); --v > -1;)((c = h[i = yt[v]] - m[i]) > 1e-6 || -1e-6 > c || null != y[i] || null != D[i]) && (d = !0, s = new ct(m, i, m[i], c, s), i in x && (s.e = x[i]), s.xs0 = 0, s.plugin = o, n._overwriteProps.push(s.n));
                    return (c = y.transformOrigin) && m.svg && (At(t, c, h), (s = new ct(m, "xOrigin", m.xOrigin, h.xOrigin - m.xOrigin, s, -1, "transformOrigin")).b = m.xOrigin, s.e = s.xs0 = h.xOrigin, (s = new ct(m, "yOrigin", m.yOrigin, h.yOrigin - m.yOrigin, s, -1, "transformOrigin")).b = m.yOrigin, s.e = s.xs0 = h.yOrigin, c = "0px 0px"), (c || bt && f && m.zOrigin) && (xt ? (d = !0, i = Tt, c = (c || H(t, i, r, !1, "50% 50%")) + "", (s = new ct(g, i, 0, 0, s, -1, "transformOrigin")).b = g[i], s.plugin = o, bt ? (p = m.zOrigin, c = c.split(" "), m.zOrigin = (c.length > 2 && (0 === p || "0px" !== c[2]) ? parseFloat(c[2]) : p) || 0, s.xs0 = s.e = c[0] + " " + (c[1] || "50%") + " 0px", (s = new ct(m, "zOrigin", 0, 0, s, -1, s.n)).b = p, s.xs0 = s.e = m.zOrigin) : s.xs0 = s.e = c) : et(c + "", m)), d && (n._transformType = m.svg && vt || !f && 3 !== this._transformType ? 2 : 3), s
                },
                prefix: !0
            }), mt("boxShadow", {
                ...
                parser: function(t, e, i, s, a) {
                    ...
                    var o, l, h, u, p, c, f, d, _, m, g, v, y, x, w, T, b = ["borderTopLeftRadius", "borderTopRightRadius", "borderBottomRightRadius", "borderBottomLeftRadius"],
                        P = t.style;
                    for (_ = parseFloat(t.offsetWidth), m = parseFloat(t.offsetHeight), o = e.split(" "), l = 0; b.length > l; l++) this.p.indexOf("border") && (b[l] = V(b[l])), -1 !== (p = u = H(t, b[l], r, !1, "0px")).indexOf(" ") && (u = p.split(" "), p = u[0], u = u[1]), c = h = o[l], f = parseFloat(p), v = p.substr((f + "").length), (y = "=" === c.charAt(1)) ? (d = parseInt(c.charAt(0) + "1", 10), c = c.substr(2), d *= parseFloat(c), g = c.substr((d + "").length - (0 > d ? 1 : 0)) || "") : (d = parseFloat(c), g = c.substr((d + "").length)), "" === g && (g = n[i] || v), g !== v && (x = Q(t, "borderLeft", f, v), w = Q(t, "borderTop", f, v), "%" === g ? (p = x / _ * 100 + "%", u = w / m * 100 + "%") : "em" === g ? (p = x / (T = Q(t, "borderLeft", 1, "em")) + "em", u = w / T + "em") : (p = x + "px", u = w + "px"), y && (c = parseFloat(p) + d + g, h = parseFloat(u) + d + g)), a = ft(P, b[l], p + " " + u, c + " " + h, !1, "0px", a);
                    return a
                },
                prefix: !0,
                ...
                parser: function(t, e, i, n, s, a) {
                    var o, l, h, u, p, c, f = "background-position",
                        ...
                        g = this.format(e);
                    if (-1 !== m.indexOf("%") != (-1 !== g.indexOf("%")) && ((c = H(t, "backgroundImage").replace(O, "")) && "none" !== c)) {
                        for (o = m.split(" "), l = g.split(" "), N.setAttribute("src", c), h = 2; --h > -1;)(u = -1 !== (m = o[h]).indexOf("%")) !== (-1 !== l[h].indexOf("%")) && (p = 0 === h ? t.offsetWidth - N.width : t.offsetHeight - N.height, o[h] = u ? parseFloat(m) / 100 * p + "px" : parseFloat(m) / p * 100 + "%");
                        m = o.join(" ")
                    }
            ...
            mt("opacity,alpha,autoAlpha", {
                ...
                parser: function(t, e, i, n, s, a) {
                    var o = parseFloat(H(t, "opacity", r, !1, "1")),
                        l = t.style,
                        h = "autoAlpha" === i;
                    return "string" == typeof e && "=" === e.charAt(1) && (e = ("-" === e.charAt(0) ? -1 : 1) * parseFloat(e.substr(2)) + o), h && 1 === o && "hidden" === H(t, "visibility", r) && 0 !== e && (o = 0), Y ? s = new ct(l, "opacity", o, e - o, s) : ((s = new ct(l, "opacity", 100 * o, 100 * (e - o), s)).xn1 = h ? 1 : 0, l.zoom = 1, s.type = 2, s.b = "alpha(opacity=" + s.s + ")", s.e = "alpha(opacity=" + (s.s + s.c) + ")", s.data = t, s.plugin = a, s.setRatio = Dt), h && ((s = new ct(l, "visibility", 0, 0, s, -1, null, !1, 0, 0 !== o ? "inherit" : "hidden", 0 === e ? "hidden" : "inherit")).xs0 = "inherit", n._overwriteProps.push(s.n), n._overwriteProps.push(i)), s
                }
            });
            var It = function(t, e) {
            ...
            mt("className", {
                parser: function(t, e, n, s, a, o, l) {
                    var h, u, p, c, f, d = t.getAttribute("class") || "",
                        _ = t.style.cssText;
                    if ((a = s._classNamePT = new ct(t, n, 0, 0, a, 2)).setRatio = Xt, a.pr = -11, i = !0, a.b = d, u = Z(t, r), p = t._gsClassPT) {
            ...
            var Nt = function(t) {
                if ((1 === t || 0 === t) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
                    ...
                    if ("all" === this.e) s.cssText = "", r = !0;
                        ...
                        for (n = (e = this.e.split(" ").join("").split(",")).length; --n > -1;) i = e[n], o[i] && (o[i].parse === a ? r = !0 : i = "transformOrigin" === i ? Tt : o[i].p), It(s, i);
                    r && (It(s, xt), this.t._gsTransform && delete this.t._gsTransform)
                }
            };
            for (mt("clearProps", {
                    parser: function(t, e, n, r, s) {
                        return (s = new ct(t, n, 0, 0, s, 2)).setRatio = Nt, s.e = e, s.pr = -10, s.data = r._tween, i = !0, s
                    }
            ...
            (l = a.prototype)._firstPT = null, l._onInitTween = function(t, e, o) {
                ...
                if (u && "" === T.zIndex && (("auto" === (l = H(t, "zIndex", r)) || "" === l) && this._addLazySet(T, "zIndex", 0)), "string" == typeof e && (_ = T.cssText, l = Z(t, r), T.cssText = _ + ";" + e, l = $(t, l, Z(t)).difs, !Y && w.test(e) && (l.opacity = parseFloat(RegExp.$1)), e = l, T.cssText = _), this._firstPT = c = this.parse(t, e, null), this._transformType) {
                    for (x = 3 === this._transformType, xt ? p && (u = !0, "" === T.zIndex && (("auto" === (v = H(t, "zIndex", r)) || "" === v) && this._addLazySet(T, "zIndex", 0)), f && this._addLazySet(T, "WebkitBackfaceVisibility", this._vars.WebkitBackfaceVisibility || (x ? "visible" : "hidden"))) : T.zoom = 1, d = c; d && d._next;) d = d._next;
                ...
                for (a in e) f = e[a], (l = o[a]) ? i = l.parse(t, f, a, this, i, s, e) : (c = H(t, a, r) + "", m = "string" == typeof f, "color" === a || "fill" === a || "stroke" === a || -1 !== a.indexOf("Color") || m && b.test(f) ? (m || (f = ((f = ot(f)).length > 3 ? "rgba(" : "rgb(") + f.join(",") + ")"), i = ft(v, a, c, f, !0, "transparent", i, 0, s)) : !m || -1 === f.indexOf(" ") && -1 === f.indexOf(",") ? (d = (u = parseFloat(c)) || 0 === u ? c.substr((u + "").length) : "", ("" === c || "auto" === c) && ("width" === a || "height" === a ? (u = tt(t, a, r), d = "px") : "left" === a || "top" === a ? (u = q(t, a, r), d = "px") : (u = "opacity" !== a ? 0 : 1, d = "")), (g = m && "=" === f.charAt(1)) ? (p = parseInt(f.charAt(0) + "1", 10), f = f.substr(2), p *= parseFloat(f), _ = f.replace(y, "")) : (p = parseFloat(f), _ = m && f.substr((p + "").length) || ""), "" === _ && (_ = a in n ? n[a] : d), f = p || 0 === p ? (g ? p + u : p) + _ : e[a], d !== _ && "" !== _ && (p || 0 === p) && u && (u = Q(t, a, u, d), "%" === _ ? (u /= Q(t, a, 100, "%") / 100, !0 !== e.strictUnits && (c = u + "%")) : "em" === _ ? u /= Q(t, a, 1, "em") : "px" !== _ && (p = Q(t, a, p, _), _ = "px"), g && (p || 0 === p) && (f = p + u + _)), g && (p += u), !u && 0 !== u || !p && 0 !== p ? void 0 !== v[a] && (f || "NaN" != f + "" && null != f) ? (i = new ct(v, a, p || u || 0, 0, i, -1, a, !1, 0, c, f)).xs0 = "none" !== f || "display" !== a && -1 === a.indexOf("Style") ? f : c : B("invalid " + a + " tween value: " + e[a]) : (i = new ct(v, a, u, p - u, i, 0, a, !1 !== h && ("px" === _ || "zIndex" === a), 0, c, f)).xs0 = _) : i = ft(v, a, c, f, !0, null, i, 0, s)), s && i && !i.plugin && (i.plugin = s);
                return i
            ...
            var Ft = function(t, e, i) {
                ...
                if (t.slice)
                    ...
                    for (r = (n = t.childNodes).length; --r > -1;) a = (s = n[r]).type, s.style && (e.push(Z(s)), i && i.push(s)), 1 !== a && 9 !== a && 11 !== a || !s.childNodes.length || Ft(s, e, i)
            };
    ...
    function(t) {
        ...
        var e = t.GreenSockGlobals || t,
            ...
            u = /(?:<br>|<br\/>|<br \/>)/gi,
            p = "<div style='position:relative;display:inline-block;" + (r.all && !r.addEventListener ? "*display:inline;*zoom:1;'" : "'"),
            c = function(t) {
                var e = -1 !== (t = t || "").indexOf("++"),
                    i = 1;
            ...
            m = function(t, e, i, a, l) {
                u.test(t.innerHTML) && (t.innerHTML = t.innerHTML.replace(u, h));
                var p, f, m, g, v, y, x, w, T, b, P, S, O, k, C = n(t),
                    ...
                    X = s(t),
                    N = o(t, "paddingLeft", X),
                    z = o(t, "borderBottomWidth", X) + o(t, "borderTopWidth", X),
                    F = o(t, "borderLeftWidth", X) + o(t, "borderRightWidth", X),
                    Y = o(t, "paddingTop", X) + o(t, "paddingBottom", X),
                    j = o(t, "paddingLeft", X) + o(t, "paddingRight", X),
                    B = o(t, "textAlign", X, !0),
                    G = t.clientHeight,
                    U = t.clientWidth,
                    V = "</div>",
                    ...
                    J = [],
                    tt = [];
                for (Q && (q = q.split("++").join("")), Z && (C = C.split("<").join("{{LT}}")), p = C.length, g = W(), v = 0; p > v; v++)
                    if (")" === (x = C.charAt(v)) && C.substr(v, 20) === h) g += ($ ? V : "") + "<BR/>", $ = !1, v !== p - 20 && C.substr(v + 20, 20) !== h && (g += " " + W(), $ = !0), v += 19;
                    else if (" " === x && " " !== C.charAt(v - 1) && v !== p - 1 && C.substr(v - 20, 20) !== h) {
                    for (g += $ ? V : "", $ = !1;
                        " " === C.charAt(v + 1);) g += D, v++;
                    (")" !== C.charAt(v + 1) || C.substr(v + 1, 20) !== h) && (g += D + W(), $ = !0)
                } else g += E && " " !== x ? H() + x + "</div>" : x;
                for (t.innerHTML = g + ($ ? V : ""), Z && d(t, "{{LT}}", "<"), p = (y = t.getElementsByTagName("*")).length, w = [], v = 0; p > v; v++) w[v] = y[v];
                if (R || L)
                    for (v = 0; p > v; v++)((m = (T = w[v]).parentNode === t) || L || E && !M) && (b = T.offsetTop, R && m && b !== I && "BR" !== T.nodeName && (f = [], R.push(f), I = b), L && (T._x = T.offsetLeft, T._y = b, T._w = T.offsetWidth, T._h = T.offsetHeight), R && (M !== m && E || (f.push(T), T._x -= N), m && v && (w[v - 1]._wordEnd = !0), "BR" === T.nodeName && T.nextSibling && "BR" === T.nextSibling.nodeName && R.push([])));
                for (v = 0; p > v; v++) m = (T = w[v]).parentNode === t, "BR" !== T.nodeName ? (L && (S = T.style, M || m || (T._x += T.parentNode._x, T._y += T.parentNode._y), S.left = T._x + "px", S.top = T._y + "px", S.position = "absolute", S.display = "block", S.width = T._w + 1 + "px", S.height = T._h + "px"), M ? m && "" !== T.innerHTML ? J.push(T) : E && K.push(T) : m ? (t.removeChild(T), w.splice(v--, 1), p--) : !m && E && (b = !R && !L && T.nextSibling, t.appendChild(T), b || t.appendChild(r.createTextNode(" ")), K.push(T))) : R || L ? (t.removeChild(T), w.splice(v--, 1), p--) : M || t.appendChild(T);
                if (R) {
                    for (L && (P = r.createElement("div"), t.appendChild(P), O = P.offsetWidth + "px", b = P.offsetParent === t ? 0 : t.offsetLeft, t.removeChild(P)), S = t.style.cssText, t.style.cssText = "display:none;"; t.firstChild;) t.removeChild(t.firstChild);
                    for (k = !L || !M && !E, v = 0; R.length > v; v++) {
                        for (f = R[v], (P = r.createElement("div")).style.cssText = "display:block;text-align:" + B + ";position:" + (L ? "absolute;" : "relative;"), q && (P.className = q + (Q ? v + 1 : "")), tt.push(P), p = f.length, y = 0; p > y; y++) "BR" !== f[y].nodeName && (T = f[y], P.appendChild(T), k && (T._wordEnd || M) && P.appendChild(r.createTextNode(" ")), L && (0 === y && (P.style.top = T._y + "px", P.style.left = N + b + "px"), T.style.top = "0px", b && (T.style.left = T._x - b + "px")));
                        0 === p && (P.innerHTML = "&nbsp;"), M || E || (P.innerHTML = n(P).split(String.fromCharCode(160)).join(" ")), L && (P.style.width = O, P.style.height = T._h + "px"), t.appendChild(P)
                    }
                    t.style.cssText = S
                }
                L && (G > t.clientHeight && (t.style.height = G - Y + "px", G > t.clientHeight && (t.style.height = G + z + "px")), U > t.clientWidth && (t.style.width = U - j + "px", U > t.clientWidth && (t.style.width = U + F + "px"))), _(i, K), _(a, J), _(l, tt)
            },
            g = f.prototype;
        g.split = function(t) {
